...
## 🎭 Multi-Turn Conversational Golden Pipeline

For testing multi-turn chatbot flows (booking flights, checking PNR status, cancellations, and agent handoffs) using **Persona Variations**, **LangSmith Trace Extraction**, and **Unified Run Evaluation**, see:

👉 **[Conversational Golden Documentation (`test/conversational_golden/README.md`)](file:///home/so-ra-gh/Dev/my_projects/RAG-Chatbot-Project/test/conversational_golden/README.md)**
